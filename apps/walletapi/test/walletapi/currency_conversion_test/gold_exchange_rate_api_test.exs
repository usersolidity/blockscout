defmodule WalletApi.GoldExchangeRateApiTest do
  ...
  @mock_data_cgld_cusd %{
    "-Lv5oAJU8dDHVfqXlKkE" => %{
      "exchangeRate" => "10.1",
      "timestamp" => 1_575_293_596_846
    },
    "-Lv5qbL_oSvKQ_452ZHh" => %{
      "exchangeRate" => "10.2",
      "timestamp" => 1_575_294_235_753
    },
    "-Lv5rRCAOhPJJqVmLiID" => %{
      "exchangeRate" => "10.3",
      "timestamp" => 1_575_294_452_181
    }
  }
  ...
  describe "goldExchangeRateApiTest" do
    test "should retrieve the closest exchange rate for cGLD/cUSD" do
      ...
      response = WalletApi.CurrencyConversion.GoldExchangeRateAPI.get_exchange_rate("cGLD", "cUSD", 1_575_294_235_653)
    ...
    test "should retrieve the closest exchange rate for cUSD/cGLD" do
      ...
      response = WalletApi.CurrencyConversion.GoldExchangeRateAPI.get_exchange_rate("cUSD", "cGLD", 1_575_294_235_653)
    ...
    test "should throw when requesting an invalid currency code" do
      ...
      response = WalletApi.CurrencyConversion.GoldExchangeRateAPI.get_exchange_rate("cUSD", "ABC", 1_575_294_235_653)
