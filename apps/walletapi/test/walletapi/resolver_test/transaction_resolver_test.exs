defmodule WalletApi.TransactionResolverTest do
  ...
  @transaction_data [
    %{
      ...
      celo_transfer: [
          ...
          %{
              ...
              token: "cUSD",
              value: Decimal.new(10000000000000000000)
          },
          %{
          ...
          %{
              ...
              token: "cUSD",
              value: Decimal.new(1991590000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0xdd1f519f63423045f526b8c83edc0eb4ba6434a4",
              token: "cUSD",
              value: Decimal.new(7966360000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
      ...
      fee_token: "cUSD",
      gas_price: %Explorer.Chain.Wei{value: Decimal.new(50000000000)},
      gas_used: Decimal.new(199159),
    ...
    %{
      ...
      celo_transfer: [
          ...
          %{
              ...
              to_address_hash: "0xa12a699c641cc875a7ca57495861c79c33d293b4",
              token: "cUSD",
              value: Decimal.new(2175980000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0x30d060f129817c4de5fbc1366d53e19f43c8c64f",
              token: "cUSD",
              value: Decimal.new(8703920000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
    ...
    %{
      ...
      celo_transfer: [
          %{
              ...
              token: "cUSD",
              value: Decimal.new(150000000000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0xa12a699c641cc875a7ca57495861c79c33d293b4",
              token: "cUSD",
              value: Decimal.new(1131780000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0x050f34537f5b2a00b9b9c752cb8500a3fce3da7d",
              token: "cUSD",
              value: Decimal.new(4527120000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
    ...
    %{
      ...
      celo_transfer: [
          ...
          %{
              ...
              to_address_hash: "0xa12a699c641cc875a7ca57495861c79c33d293b4",
              token: "cUSD",
              value: Decimal.new(1297230000000000)
          },
          %{
              from_address_hash: "0xf4314cb9046bece6aa54bb9533155434d0c76909",
              to_address_hash: "0x2a43f97f8bf959e31f69a894ebd80a88572c8553",
              token: "cUSD",
              value: Decimal.new(5188920000000000)
          },
          %{
              from_address_hash: "0xf4314cb9046bece6aa54bb9533155434d0c76909",
              to_address_hash: "0xfcf7fc2f0c1f06fb6314f9fa2a53e9805aa863e0",
    ...
    %{
      ...
      fee_currency: nil,
      fee_token: "cGLD",
      gas_price: %Explorer.Chain.Wei{value: Decimal.new(5000000000)},
    ...
    %{
      ...
      celo_transfer: [
          %{
              ...
              to_address_hash: "0x0000000000000000000000000000000000007E57",
              token: "cGLD",
              value: Decimal.new(5000000000000000000)
          },
      ],
      fee_currency: nil,
      fee_token: "cGLD",
    ...
    %{
      ...
      celo_transfer: [
          %{
              ...
              token: "cUSD",
              value: Decimal.new(200000000000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0xa12a699c641cc875a7ca57495861c79c33d293b4",
              token: "cUSD",
              value: Decimal.new(1590510000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0xae1ec841923811219b98aceb1db297aade2f46f3",
              token: "cUSD",
              value: Decimal.new(6362040000000000)
          },
      ],
      fee_currency: "0xa561131a1c8ac25925fb848bca45a74af61e5a38",
      fee_token: "cUSD",
      gas_price: %Explorer.Chain.Wei{value: Decimal.new(50000000000)},
      gas_used: Decimal.new(159051),
      gateway_fee: %Explorer.Chain.Wei{value: Decimal.new(0)},
      gateway_fee_recipient: nil,
    ...
    %{
      ...
      celo_transfer: [
          %{
              ...
              to_address_hash: "0xa12a699c641cc875a7ca57495861c79c33d293b4",
              token: "cUSD",
              value: Decimal.new(990330000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0x456f41406b32c45d59e539e4bba3d7898c3584da",
              token: "cUSD",
              value: Decimal.new(3961320000000000)
          },
          %{
              from_address_hash: "0x0000000000000000000000000000000000007E57",
              to_address_hash: "0x6a0edf42f5e618bee697e7718fa05efb1ea5d11c",
  ...
  describe "transactionResolver" do
    test "should get dollar transaction and label them properly"  do
      GetTransactionBehaviorMock |> expect(:get_transaction_data, fn _args ->
        @transaction_data
      end)
